...
ratio_tree<-gls(ratio ~ 1, corr_data, correlation = corPagel(0.5, corr_tree)) # lambda = 0.763
##compare models
...
leafarea_tree<-gls(leaf_area ~ 1, corr_data, correlation = corPagel(0.5, corr_tree)) # lambda = 0.413
##compare models

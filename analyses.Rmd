...
ggplot(corr_data, mapping=aes(x= log(ratio), y = log(height)))+
  geom_point(pch = 1)+
...
summary(pgls(log_height ~ log_leaf_shape, cdat, lambda = "ML")) #NO multiple R2 = 0.00082
...
ggplot(trait_npp_data, mapping=aes(x= log(leafshape), y = log(treeheight)))+
  geom_point(pch = 1)+
  geom_smooth(method = "lm")+
  theme_bw()
```

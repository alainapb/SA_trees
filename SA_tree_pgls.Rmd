...
library(rhdf5)
#this is multiple data frames combined
bio<-h5read("~/Downloads/GFED4.1s_2013.hdf5", "biosphere") #only bull out biotic data
str(bio) 

grids<-h5read("~/Downloads/GFED4.1s_2013.hdf5", "ancill") #pull out grid data
